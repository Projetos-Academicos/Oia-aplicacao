...
import CreateJob from './src/screen/CreateJob';
import ExitScreen from './src/screen/ExitScreen';
...
const CustomDrawerComponent = (props) => {
  ...
  <SafeAreaView style={{flex: 1}}>
    <View style={{height: 150, backgroundColor: '#5C5C5C', alignItems: 'center', justifyContent: 'center'}}>
      <Image source={require('./src/image/user.png')} style={{height: 120, width: 120, borderRadius: 60}} />
    </View>
    <ScrollView>
      <DrawerItems {...props} />
    </ScrollView>
