...
import FlatCandidatadas from '../components/FlatCandidatadas';

export default class OiaCandidatadas extends React.Component{
    state = {
        listVagas: [
            {
                id: 1,
        ...
        return(
         <View style={styles.container}>
            <FlatCandidatadas
                ...
                this.props.navigation.navigate('PageDetailsCandidatadas', pageParams);
                }}/>
         </View>
        );
    }
